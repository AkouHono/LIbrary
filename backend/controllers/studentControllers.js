...
class StudentController {
  async createStudent(req, res, next) {
    ...
    try {
      ...
      await sendMail({
        to: req.body.email,
        subject: `Welcome to Library Management System - Password Reset Required`,
        text: `Dear ${req.body.name},
                    Welcome to the Library Management System! Your account has been created by our admin.
                    Login Credentials:
